  ...
  return (
    <>
      ...
      <div className="responsive-grid" style={{ display: 'grid', gap: '1.5rem' }}>
        {matches.map((match) => (
          <div key={match.id} className="glass mobile-stack" style={{ padding: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '2rem' }}>
            <div style={{ flex: 1, width: '100%' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '1rem' }} className="mobile-text-center">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }} className="mobile-stack">
